...
augroup filetype_group
    ...
    autocmd FileType gitcommit setlocal nofoldenable cursorline colorcolumn=80
    autocmd FileType gitsendemail setlocal colorcolumn=80
    autocmd FileType diff setlocal colorcolumn=80
